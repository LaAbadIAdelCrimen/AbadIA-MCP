7. [x] Implement the `find_path_to_location` tool.
   7.1. [x] Create a new endpoint `/tools/find_path_to_location` in `server/main.py`.
   7.2. [x] Implement the pathfinding logic using the A* algorithm.
...
13. [x] Document Server Operation
    13.1. [x] Create `docs/server_info.md` describing architecture and endpoints.
    13.2. [x] Propose SSE refactor plan in `docs/plans/251222_mcp_sse_refactor_proposal.md`.
