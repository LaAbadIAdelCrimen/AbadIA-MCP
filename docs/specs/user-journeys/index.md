# Index: User Journeys (Exploration Protocols)

Evolutive patterns of behavior based on game mechanics and HE v3.0 logic.

| Journey ID | Title | Description |
| :--- | :--- | :--- |
| [[guillermo-01-navegacion-entre-habitaciones]] | Room Navigation | Dynamic pathfinding with NPC avoidance. |
| [[guillermo-02-investigacion-sistematica-objetos]] | Object Investigation | Protocol for mapping and interacting with objects. |
...
---
*Identity: Dynamic Exploration Protocols*
